 ...
 * @author wesker
 */
public class VistaPlantelOtroEquipo extends javax.swing.JFrame {
     ...
     * @param LigaSelec
     */
    public VistaPlantelOtroEquipo(Mundo wor,Equipo EquipoSel,Liga LigaSelec) {
        initComponents();
        this.wor = wor;
        this.Previous = LigaSelec;
        this.EquipoSelect = EquipoSel;
    ...
    private void initComponents() {
        ...
        jButton6.setText("Preguntarle por venir al equipo");
        ...
        jButton7.setText("Ofrecer transferencia");
    ...
    private void AvanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AvanzarActionPerformed
        ...
        VistaTabla vistis = new VistaTabla(wor,Previous);
    ...
    public void RenderizarVista(){
        NombreEquipo.setText(EquipoSelect.NombreEquipo);
        ...
        for (Futbolista x : EquipoSelect.OnceInicial){
        ...
        Indies = 0;
        Reservas.removeAll();
        for (Futbolista y : EquipoSelect.Reserva){
            VistaJugador vivi = new VistaJugador();
            vivi.Ajustar(y);
